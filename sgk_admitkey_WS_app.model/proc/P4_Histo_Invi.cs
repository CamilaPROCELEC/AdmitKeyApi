...
{
    public class P4_Histo_Invi
    {
        public static Response historial(P4_histo_invi historial)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    vector[3] = "@fech_ini,v," + historial.fech_ini;
                    vector[4] = "@fech_fina,v," + historial.fech_fina;
